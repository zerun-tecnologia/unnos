...
import { setMatchWinner, type MatchDetail } from '@/actions/match'

import { CustomRadio } from '../custom-radio'
import { FormEvent, useReducer } from 'react'
import { formReducer, SetWinnerFormProps } from '@/reducers/set-winner-reducer'
import { setMatchWinnerFormSchema, SetMatchWinnerMatchOutput } from '@/app/validation/set-match-winner-form-schema'
...
export function SelectWinnerModal() {
  ...
  const handleSubmitMutation = useMutation({
    mutationFn: async (data: SetMatchWinnerMatchOutput) => await setMatchWinner(match.id, data),
    onSuccess: () => {
      addToast({
        color: 'success',
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              <ModalBody className="w-full">
                <RadioGroup isDisabled={handleSubmitMutation.isPending} onChange={e => {
