export function LogoUnnos() {
  return (
    <div className="text-xl font-bold text-primary flex gap-1">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="icon icon-tabler icons-tabler-filled icon-tabler-cards">
      ...
      <span className="text-foreground">Unnos</span>
    </div>
  )
}
