      ...
      <div className="py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Browse, filter and manage matches</p>
          </div>
          <Button as={Link} href="/create-match"className="mt-4 md:mt-0 rounded-full">
        ...
        {filteredMatches.length === 0
          ? (
              <div className="text-center py-12">
                <div className="text-lg text-muted-foreground mb-4">No matches found</div>
                <Button as={Link} href="/create-match" variant="bordered">
                  Create a Match
                </Button>
              </div>
            )
